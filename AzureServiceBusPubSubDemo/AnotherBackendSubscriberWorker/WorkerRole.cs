...
namespace AnotherBackendSubscriberWorker
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        public override void Run()
        {
            ...
            subscriptionClient.OnMessage( ( receivedMessage ) =>
            {
                try
                {
                    ...
                    var reply = new MyMessage() { Message = "Event received by 'AnotherBackendSubscriberWorker': " + body.Message + " -> " + DateTimeOffset.Now.Ticks };
        ...
        public override bool OnStart()
        {
            ...
            NamespaceManager.CreateFromConnectionString( connectionString )
                .CreateSubscriptionIfNotExists( topicName, "AnotherBackendSubscriberWorker-Subscription" )
            ...
            subscriptionClient = SubscriptionClient.CreateFromConnectionString(
                connectionString,
                topicName,
                "AnotherBackendSubscriberWorker-Subscription" );
